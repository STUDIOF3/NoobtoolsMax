...
class NoobToolsWindow(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        # Conexão para atualizar info ao clicar no item
    ...
    def update_asset_info(self):
        """Atualiza o painel de informações com dados do arquivo 3D"""
        ...
        if target_file:
            ...
            try:
                ...
                # Formatação de Cor para arquivos pesados (>100MB)
    ...
    def update_progress(self, val, message):
        ...
        # Força a atualização da UI do Qt mesmo com o script rodando
